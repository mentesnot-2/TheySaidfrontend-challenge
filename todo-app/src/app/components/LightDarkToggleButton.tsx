...
const LightDarkToggleButton:React.FC<LightDarkToggleButtonProps> = ({darkMode,setDarkMode}) => {
    ...
    return (
        <div className="flex flex-col justify-center ml-3" onClick={toggleDarkMode}>
            ...
            <label className="relative cursor-pointer p-2" htmlFor="light-switch">
                <svg className="dark:hidden" width="32" height="32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                ...
                <svg className="hidden dark:block" width="32" height="32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
